...
import CompSortedList from './components/CompSortedList';
...
const ClassementComposMetier = () => {
  ...
  return (
    <React.Fragment>
      <CssBaseline />
      <Container>
        <h3>Classement des composants pour un user et un menu</h3>
        <Grid container spacing={2} >
            ...
            <Grid item xs={12} md={8}>
                <Item>
                    <CompSortedList Cible={WsContent} />  
                </Item>
            </Grid>
        </Grid>
      </Container>
...
export default ClassementComposMetier